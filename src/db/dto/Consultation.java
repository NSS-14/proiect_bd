...
public class Consultation {
    ...
    public Timestamp dateOfCompletion;
    ...
    public Consultation(int id, Timestamp dateOfCreation, Timestamp dateOfCompletion, Timestamp scheduledDate, Person person, Doctor doctor) {
        this.id = id;
    ...
    public ArrayList<AttributeValuePair> getPairs() {
        ...
        Object fieldValue;
        Field[] fields = Consultation.class.getDeclaredFields();
